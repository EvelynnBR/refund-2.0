...
export function Dashboard() {
  ...
  function featRefunds(e: React.FormEvent) {
    e.preventDefault()
    console.log(name)
  }
  ...
  return (
    <div className="bg-gray-500 rounded-xl p-10 md:min-w-3xl">
      ...
      <form
        onSubmit={featRefunds}
        className="flex flex-1 items-center justify-between pb-6 border-b border-b-gray-400 mb:flex-row gap-2 mt-6"
      >
        <Input
